                ...
                >
                    {navigationTabs.map((tab) => (
                        <button
                            ...
                            className={`py-5 border-b-2 -mb-[1px] transition-colors outline-none ${activeTab === tab.label
                                ? "border-[#FF8936]"
                ...
                <main className="flex w-full p-[60px]">
                    <article className="flex w-full items-center justify-between gap-[60px]">
                        <div className="flex flex-col flex-1 max-w-[550px] items-start gap-8">
                            ...
                            <button
                                className="inline-flex justify-center mt-2 px-8 py-3.5 bg-[#ffe9da] hover:bg-[#ffd9c4] transition-colors focus:ring-2 focus:ring-[#FF8936]/50 outline-none"
