...
export default function ReadMoreGem({ onClose }: ReadMoreGemProps) {
    return (
        <div className="flex flex-col w-full px-4 lg:px-[60px] pb-8 lg:pb-[60px] gap-6 lg:gap-8 mt-2">
            <div className="grid grid-cols-1 lg:grid-cols-2 border border-[#CED4DA] bg-white">
                {/* Left col */}
            ...
            <div className="flex flex-col border border-[#CED4DA] bg-white">
                {/* Banner */}
                <div className="bg-[#FFF8F4] py-8 lg:py-[40px] px-6 lg:px-[60px] flex flex-col lg:flex-row items-start lg:items-center justify-between relative overflow-hidden w-full h-auto lg:h-[168px] opacity-100 gap-6 lg:gap-0">
                    ...
                    <div className="absolute left-[70%] lg:left-1/2 top-1/2 lg:-top-[10px] -translate-x-1/2 -translate-y-1/2 w-[200px] lg:w-[280px] h-[200px] lg:h-[280px] opacity-[0.1] lg:opacity-[0.8] flex items-center justify-center pointer-events-none">
                ...
                {/* Stats */}
                <div className="grid grid-cols-1 lg:grid-cols-3 border-t border-[#CED4DA]">
                    {/* Stat 1 */}
                    <div className="p-8 lg:p-[40px] px-6 lg:px-8 border-b lg:border-b-0 lg:border-r border-[#CED4DA] flex flex-col items-center text-center">
                        <div className="font-['Very_Vogue-Display',Helvetica] text-[40px] lg:text-[48px] font-normal text-[#FF8936] leading-[1.1]">35</div>
                        <div className="font-['Very_Vogue-Display_Italic',Helvetica] font-normal text-[#FF8936] text-[24px] lg:text-[28px] mb-1 tracking-[0px]">Years of Legacy</div>
                    ...
                    {/* Stat 2 */}
                    <div className="p-8 lg:p-[40px] px-6 lg:px-8 border-b lg:border-b-0 lg:border-r border-[#CED4DA] flex flex-col items-center text-center">
                        <div className="font-['Very_Vogue-Display',Helvetica] text-[40px] lg:text-[48px] font-normal text-[#FF8936] leading-[1.1]">98%</div>
                        <div className="font-['Very_Vogue-Display_Italic',Helvetica] font-normal text-[#FF8936] text-[24px] lg:text-[28px] mb-1 tracking-[0px] ">Happy Clients</div>
                        <div className="flex justify-center mb-4">
                            <DividerOrnament />
                        </div>
                    ...
                    <div className="p-8 lg:p-[40px] px-6 lg:px-8 flex flex-col items-center text-center">
                        <div className="font-['Very_Vogue-Display',Helvetica] text-[40px] lg:text-[48px] font-normal text-[#FF8936] leading-[1.1]">100%</div>
                        <div className="font-['Very_Vogue-Display_Italic',Helvetica] font-normal text-[#FF8936] text-[24px] lg:text-[28px] mb-1">Lab Certified</div>
                        <div className="flex justify-center mb-4">
                            <DividerOrnament />
                        </div>
